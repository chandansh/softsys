									...
									<div id="sidebar">
										...
										<!-- Sidebar -->			
											...
											<section>
												...
												<ul class="style2">
													<li><a href="/solution/portalDev.jsp">Portal Developement</a></li>
													<li><a href="/solution/telecom.jsp">Telecom</a></li>
													<li><a href="/solution/intranet.jsp">Intranet</a></li>													
													<li><a href="/solution/health.jsp">Health Care</a></li>
													<li><a href="/solution/eCommerce.jsp">E-Commerce</a></li>
													<li><a href="/solution/eLearning.jsp">Education</a></li>
													<li><a href="/solution/travel.jsp">Travel</a></li>
												</ul>												
											</section>
